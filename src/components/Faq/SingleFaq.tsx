const SingleFaq = (props: { question: string; answer: string }) => {
  ...
  return (
    <div className="mb-8 lg:mb-12">
      <div className="rounded-xl bg-[#1D2939]/40 p-6 backdrop-blur-sm transition-all duration-300 hover:bg-[#1D2939]/60">
        <div className="flex items-start">
          <div className="mr-4 flex-shrink-0">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#4B6BFB]/20 text-[#4B6BFB]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
          ...
          <div>
            <h3 className="mb-3 text-xl font-semibold text-[#4B6BFB]">
              {question}
            </h3>
            <p className="text-base leading-relaxed text-gray-200">{answer}</p>
          </div>
        </div>
      </div>
    </div>
